...
model = DNN_custom(dim_in=dim_in, dim_out=dim_out, hidden_layer_centres=hidden_layer_centres, ub=dataset.ub, lb=dataset.lb).to(device).to(torch.float64)

model.load_state_dict(torch.load("./logs/models/2023-09-29-09-26-16_2d_steady_ns_dnn128_100X5/epoch_34000.pt"))
